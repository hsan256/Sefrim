...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    <?php
      ...
      $stmt=$db_con->prepare("SELECT * FROM product WHERE name=:mn");
      $stmt->execute(array(':mn'=>$search));
      $d=$stmt->fetch(PDO::FETCH_ASSOC);

      $nom = $d['name'];
      $tauxpromo = $d['tauxpromo'];

      if($nom == $search && $tauxpromo != 0){
        ...
        $stmt=$db_con->prepare("SELECT * FROM product WHERE name=:mn AND tauxpromo != 0");
        $stmt->execute(array(':mn'=>$search));
        ...
        elseif ($tauxpromo == 0 && $nom == $search) {
          echo '<b><font color="red" >Sorry! record is not on Promotion.</font></b><br>';
        }
        elseif ($tauxpromo == 0 && strcmp($nom,$search)!=0){
