            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  <thead>
                    <tr>
                      <th class="sorting" tabindex="0" aria-controls="data-table-6" rowspan="1" colspan="1" aria-label="Customer Name: activate to sort column ascending" style="width: 200px;">Nom du produit</th>
                      <th>Disponibilité</th>
                  ...
                  $stmt = $db_con->prepare("SELECT * FROM product where tauxpromo = 0 LIMIT {$startpoint} , {$per_page} ");
                  $stmt->execute();
                  ...
                  echo'
                    ...
                    echo'
                      ...
                      <td>'.$pr.' Dinar/KG  </td>
                      <td>'.$qt_dispo.'</td>
                      <td><a href="AjoutPromotion2.php?pid='.$pid.'" ><i class="fas fa-paper-plane ms-text-primary"></i></a></td>
                    </tr>
                    <div class="col-md-12">
