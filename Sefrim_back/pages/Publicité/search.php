  ...
  <main class="body-content">
    ...
    <?php
      ...
      if($nom == $search && $pub != 0){
        ...
        $stmt=$db_con->prepare("SELECT * FROM product WHERE name=:mn AND pub != 0");
        $stmt->execute(array(':mn'=>$search));
        ...
        elseif ($pub == 0 && $nom == $search) {
          echo '<b><font color="red" >Sorry! record is not on advertisment.</font></b><br>';
        }
        else{
