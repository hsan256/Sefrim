          ...
          <div class="no-js"> <a title="Company" class="clicker"></a>
            <div class="fl-nav-links">
              <div class="language-currency">
                    ...
                    <p style="color:#88BE4C; margin-left: 10px;">Welcome <!--tap name here session--></p>
  ...
  <div class="breadcrumbs">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <ul>
            <li class="home"> <a href="Accueil.php" title="Go to Home Page">Home</a> <span>—› </span> </li>
...
<div class="newsletter-row">
  ...
  <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col">
    ...
    <div class="co-info">
            <div><a href="Accueil.php"><img src="images/logo.png" alt="footer logo"></a></div>
            <address>
