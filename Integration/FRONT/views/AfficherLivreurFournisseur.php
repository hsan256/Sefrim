...
<!-- Mirrored from themesground.com/flavours/version1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2020 11:51:17 GMT -->
<head>
    ...
    <div id="header">
     ...
     <div class="row">
        <div class="logo"> <a href="index.html" title="Flavours HTML">
          <div><img src="images/logo3.png" alt="Flavours Store" style="width: 80%"></div>
          </a> </div>
            ...
            <nav>
              ...
              <div class="nav-inner">
                ...
                <ul id="nav" class="hidden-xs">
                  ...
                  <li class="mega-menu"> <a class="level-top" href="grid.html"><span>LES FRUITS</span></a>
                  ...
                  <li class="mega-menu"> <a class="level-top" href="grid.html"><span>LES LÉGUMES</span></a>
                    <div class="level0-wrapper dropdown-6col" style="left: 0px; display: none;">
                      <div class="container">
                        <div class="level0-wrapper2">
                          <div class="nav-block nav-block-center">
                  ...
                  <li class="mega-menu"> <a class="level-top" href="grid.html"><span>AUTRES PRODUITS</span></a>
                    <div class="level0-wrapper dropdown-6col" style="left: 0px; display: none;">
                      <div class="container">
                        <div class="level0-wrapper2">
                          <div class="nav-block nav-block-center">
        ...
        <div class="slider-items slider-width-col4 products-grid">
                            ...
                            <div class="item-inner">
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  <div class="item-title"><a href="product-detail.html" title="tomate">oignon</a> </div>
                                  <div class="item-content">
                                    ...
                                    <div class="item-price">
                                      <div class="price-box"><span class="regular-price" ><span class="price">3 dt</span> </span> </div>
                                    </div>
                  <div class="add_cart">
                                        <button class="button btn-cart" type="button"><span>Ajouter au panier</span></button>
                                      </div>
                                  </div>
                                </div>
                              </div>
          ...
          <div class="item">
                            <div class="item-inner">
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  <div class="item-title"><a href="product-detail.html" title="Retis lapen casen">mais</a> </div>
                                  <div class="item-content">
                                    <div class="rating">
                                      <div class="ratings">
                                        <div class="rating-box">
                                    ...
                                    <div class="item-price">
                                      <div class="price-box"><span class="regular-price" ><span class="price">2 dt</span> </span> </div>
                                    </div>
                  <div class="add_cart">
                                        <button class="button btn-cart" type="button"><span>Ajouter au panier</span></button>
                                      </div>
          ...
          <div class="item">
                            <div class="item-inner">
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  <div class="item-title"><a href="product-detail.html" title="Retis lapen casen">tomate</a> </div>
                                  <div class="item-content">
                                    <div class="rating">
                                      <div class="ratings">
                                        <div class="rating-box">
                                    ...
                                    <div class="item-price">
                                      <div class="price-box"><span class="regular-price" ><span class="price">1.5 dt</span> </span> </div>
                                    </div>
                  <div class="add_cart">
                                        <button class="button btn-cart" type="button"><span>Ajouter au panier</span></button>
                                      </div>
          ...
          <div class="item">
                            <div class="item-inner">
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  <div class="item-title"><a href="product-detail.html" title="Retis lapen casen">petit pois</a> </div>
                                  <div class="item-content">
                                    <div class="rating">
                                      <div class="ratings">
                                        <div class="rating-box">
          ...
          <div class="item">
                            <div class="item-inner">
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  <div class="item-title"><a href="product-detail.html" title="Retis lapen casen">cerice</a> </div>
                                  <div class="item-content">
                                    <div class="rating">
                                      <div class="ratings">
                                        <div class="rating-box">
                                    ...
                                    <div class="item-price">
                                      <div class="price-box"><span class="regular-price" ><span class="price">4.5 dt</span> </span> </div>
                                    </div>
                  <div class="add_cart">
                                        <button class="button btn-cart" type="button"><span>Ajouter au panier</span></button>
                                      </div>
          ...
          <div class="item">
                            <div class="item-inner">
                              ...
                              <div class="item-info">
                                <div class="info-inner">
                                  <div class="item-title"><a href="product-detail.html" title="Retis lapen casen">PETIT PANIER DE FRUITS ET LÉGUMES</a> </div>
                                  <div class="item-content">
                                    <div class="rating">
                                      <div class="ratings">
                                        <div class="rating-box">
                                    ...
                                    <div class="item-price">
                                      <div class="price-box"><span class="regular-price" ><span class="price">8 dt</span> </span> </div>
                                    </div>
                  <div class="add_cart">
                                        <button class="button btn-cart" type="button"><span>Ajouter au panier</span></button>
                                      </div>
...
<?php
 ...
 //$listeLivreur= $livreurC->AfficherLivreur();
    ...
    $nom="SELECT Nom,Prenom from livreur";
    $listeLivreurs=mysqli_query($conn,$nom);
...
<!-- partie livreur metier-->
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 testimonials-section">
      ...
      <ul class="bxslider">
          <?php while($row=mysqli_fetch_array($listeLivreurs)){ ?>   
          <li>
              <!-- <div class="avatar"><img src="images/photo.jpg" alt="Image"></div> -->
               <div class="testimonials">"Ces livreurs sont toujours à votre disponibilité ."</div>
...
<!-- /partie livreur metier-->
  ...
  <div class="newsletter-row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 col"> 
      ...
      <div class="co-info">
              <div><a href="index.html"><img src="images/logo7.png" alt="footer logo"></a></div>
              <address>
...
<!-- Mirrored from themesground.com/flavours/version1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2020 11:55:29 GMT -->
</html>
