...
<?php 
      ...
      $listeProduit= $ProduitC->RecupererProduitWL();
          ...
          <?php
                    ...
                    ?>
                      <div class="alert alert-danger" role="alert">
                       <strong>Succès!</strong> Produit retiré du liste souhait.
                     </div>
                    <?php }?>
                                ...
                                <div class="item-img-info"><a href="product-detail.html" title="Retis lapen casen" class="product-image"><img src="<?php echo($image); ?>" alt="Retis lapen casen"></a>
                                  ...
                                  <div class="item-box-hover">
                                    <div class="box-inner">
                                      ...
                                      <input type="image" src="images/heart.png" class="button detail-bnt" onclick="window.location.href='SupprimerProduitWL.php?Id=<?php echo $row['Id']; ?>&categories=<?php echo $varb ?>';">
                                      </div>
                                    </div>
                                  </div>
                                </div>
      ...
      <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow bounceInUp animated"> 
       ...
       foreach ($listeProduit2 as $row) 
        ...
        <div class="block block-list block-cart">
          ...
          <div class="block-content">
            <div class="summary">
              <p class="amount">il y a  <a href="#"> 1 articles </a> dans votre liste de souhait.</p>
            </div>
