...
<!-- Mirrored from themesground.com/flavours/version1/blog-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2020 11:56:27 GMT -->
<head>
          ...
          <div class="fl-cart-contain">
            <div class="mini-cart">
              ...
              <div class="fl-mini-cart-content" style="display: none;">
                ...
                <div class="actions">
                  <button class="btn-checkout" title="Checkout" type="button" onClick="window.location=checkout.html"><span>Check-out</span></button>
                </div>
                <!--actions-->
              </div>
...
$listeArticle= $article1C->RecupererArticle($_GET['Id']);
 ini_set('display_errors',0);

 include_once "../core/commentaireC.php";
$commentaire1C=new commentaireC();
$listeCommentaire= $commentaire1C->RecupererCommentaire($_GET['Id']);
      ...
      <?php foreach ($listeArticle as $row) 
           ...
           <div class="blog_entry-header-inner">
						<h2 class="blog_entry-title">
							<?php echo $row['Titre'] ?>			</h2>
             </div> <!--blog_entry-header-inner-->
					</header> <!--blog_entry-header clearfix-->
					<div class="entry-content">
						<div class="featured-thumb"><a href="#"><img src="<?php echo $Image ?>  " alt="blog-img4"></a></div>
                        <br>
<div class="entry-content">
...
<h5>Vous Voulez Ajouter Un Commentaire</h5> 
<form method="POST" action="AjoutCommentaire.php?Id=<?php echo $Id_article; ?>">
   <div id="container_form_news2">
                    <input type="text" name="Description" id="newsletter1" title="Sign up for our newsletter" class="input-text required-entry validate-email" placeholder="Ajouter Un Commentaire">
                    <button type="submit" title="Subscribe" class="button "><span>Ajouter </span> </button>
                    
                  </div> 
     <?php foreach ($listeCommentaire as $row) 
                        { $Id_commentaire=$row['Id'];
              ?>

              <h5 ><?php echo $row['Description'] ?> <a  href="SupprimerCommentaire.php?id=<?php echo $Id_commentaire ?>">Supprimer</a></h5>  
 <?php } 
                    ?>
