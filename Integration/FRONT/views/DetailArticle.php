...
$var=$_GET['Id'];
$listeArticle= $article1C->RecupererArticle($var);
      ...
      <?php foreach ($listeArticle as $row) 
           ...
           <div class="blog_entry-header-inner">
					...
					<div class="entry-content">
						<div class="featured-thumb"><img src="<?php echo $Image; ?>  "></div>
                        <br>
<div class="entry-content">
...
<form method="POST" action="AjoutCommentaire.php?Id=<?php echo $row['Id'] ; ?>">
