...
<!-- Mirrored from themesground.com/flavours/version1/grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2020 11:55:59 GMT -->
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>Flavours Grid Page</title>
            ...
            <nav>
              ...
              <div class="nav-inner">
                ...
                <ul id="nav" class="hidden-xs">
                        ...
                        <div class="level0-wrapper2">
                          <div class="col-1">
                            <div class="nav-block nav-block-center">
                              <!--mega menu-->
                              <ul class="level0">
                                <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Agrumes</span></a>
                                  <!--sub sub category-->
                                  <ul class="level1">
                                   
                                    <!--level2 nav-6-1-1-->
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Oranges à jus</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Oranges thomson</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Citron</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                                ...
                                <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>LÉGUMES-FRUITS</span></a>
                                  <!--sub sub category-->
                                  <ul class="level1">
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Avocat</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                                ...
                                <!--level3 nav-6-1 parent item-->
                                <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>PEPINS</span></a>
                                  <!--sub sub category-->
                                  <ul class="level1">
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Kiwi</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Pommes</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                                ...
                                <!--level3 nav-6-1 parent item-->
                                <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>TROPICAUX</span></a>
                                  <!--sub sub category-->
                                  <ul class="level1">
                                    <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Bananes</span></a> </li>
                                    <!--level2 nav-6-1-1-->
                  ...
                  <li class="mega-menu"> <a class="level-top" href="AfficherProduit.php?categories=legume"><span>LES LÉGUMES</span></a>
                    <div class="level0-wrapper dropdown-6col" style="left: 0px; display: none;">
                      <div class="container">
                        <div class="level0-wrapper2">
                          <div class="nav-block nav-block-center">
                            <!--mega menu-->
                            <ul class="level0">
                              <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Bulbes</span></a>
                                <!--sub sub category-->
                                <ul class="level1">
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Oignons blancs</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Oignons jaunes</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Ail blanc</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                              ...
                              <!--level3 nav-6-1 parent item-->
                              <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Feuilles</span></a>
                                <!--sub sub category-->
                                <ul class="level1">
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Blettes</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Epinards</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Menthe</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Persil la botte</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Salade romaine</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                </ul>
                                <!--level1-->
                                <!--sub sub category-->
                              ...
                              <!--level3 nav-6-1 parent item-->
                              <li class="level3 nav-6-1 parent item"> <a href="grid.html"><span>Racines</span></a>
                                <!--sub sub category-->
                                <ul class="level1">
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Tomates</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Poivrons</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Fenouil</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Choux-fleur</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                </ul>
                                <!--level1-->
                                <!--sub sub category-->
                  ...
                  <li class="mega-menu"> <a class="level-top" href="AfficherProduit.php?categories=autre_produit"><span>AUTRES PRODUITS</span></a>
                    <div class="level0-wrapper dropdown-6col" style="left: 0px; display: none;">
                      <div class="container">
                        <div class="level0-wrapper2">
                          <div class="nav-block nav-block-center">
                            ...
                            <ul class="level0">
                                ...
                                <!--sub sub category-->
                                <ul class="level1">
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Houiles d'olive</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Miel</span></a> </li>
                                  <!--level2 nav-6-1-1-->
                                  <li class="level2 nav-6-1-1"> <a href="grid.html"><span>Fromage</span></a> </li>
                                  <!--level2 nav-6-1-1-->
...
<?php 
      ...
      $PopoupProduit= $ProduitC->ProduitPopup($currentId);
                              ...
                              <div class="item-img">
                                <div class="item-img-info"><a href="product-detail.html" title="Retis lapen casen" class="product-image"><img src="<?php echo($image); ?>" alt="Retis lapen casen"></a>
                                  ...
                                  <div class="item-box-hover">
                                    <div class="box-inner">
                                      <div class="product-detail-bnt" style="margin-right: 10px;">
                                      <input type="image" src="images/search-icon.png" class="button detail-bnt" onclick="OpenModal();?>"><span></span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
      ...
      <aside class="col-left sidebar col-sm-3 col-xs-12 col-sm-pull-9 wow bounceInUp animated"> 
       ...
       foreach ($listeProduit2 as $row) 
        ...
        <div class="block block-list block-cart">
          ...
          <div class="block-content">
            <div class="summary">
              <p class="amount">il y a des <a href="#"> 1 articles </a> dans votre panier.</p>
              <p class="subtotal"> <span class="label">totale :</span> <span class="price">$299.00</span> </p>
            </div>
...
<!--                       POPUP                        -->
  ...
  <div class="quick-view-box"  id="modal">
    <?php foreach ($PopoupProduit as $row) 
                        { 
                        $imgpop=$row['Image']; 
                        $imagepop="../../BACK/views/".$imgpop;
                   ?>

<input type="image" name="btnmodal" src="images/close-icon.png" alt="close" class="x" onclick="CloseModal()">
            ...
            <div class="row">
              ...
              <form action="#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-sm-6 col-xs-12">
                  <div class="new-label new-top-left"> Nouveau </div>
                  <div class="product-image">
                    <div class="large-image"> <a href="<?php echo($imagepop); ?>" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img src="<?php echo($imagepop); ?>"> </a> </div>
                    <div class="flexslider flexslider-thumb">
                      <ul class="previews-list slides">
                        <li><a href='products-images/p15.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 1"/></a></li>
                        <li><a href='products-images/p10.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p3.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 1"/></a></li>
                        <li><a href='products-images/p4.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p5.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p8.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p10.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '<?php echo($imagepop); ?>' "><img src="<?php echo($imagepop); ?>" alt = "Thumbnail 2"/></a></li>
                      </ul>
                    </div>
                  </div>
                ...
                <div class="product-shop col-sm-6 col-xs-12">
                  ...
                  <div class="product-name">
                    <h1 itemprop="name"><?php echo $row['Nom'];  ?></h1>
                  </div>
                  <!--product-name-->
                  ...
                  <div class="rating">
                    <div class="ratings">
                      ...
                      <p class="rating-links"><a href="#">1 Revue(s)</a> <span class="separator">|</span> <a href="#">Ajouter un Revue</a> </p>
                    </div>
                  </div>
                  </span>
                  <div class="price-block">
                    <div class="price-box"> <span class="regular-price" id="product-price-123"> <span class="price"><?php echo $row['Prix']; ?>.DT</span> </span> </div>
                    <p class="availability in-stock">
                      <?php if($row['Quantite'] > 0){ ?>
                      <span>En stock</span></p>

                      <?php }else if($row['Quantite']==0){?>
                      <p class="availability out-of-stock">
                      <span>Stock épuisé</span></p>
                    <?php }?>
                  </div>
                  <!--price-block-->
                  ...
                  <div class="add-to-box">
                    <div class="add-to-cart">
                      ...
                      <!--pull-left-->
                      <button type="button" title="Add to Cart" class="button btn-cart" onClick="productAddToCartForm.submit(this)"><span><i class="icon-basket"></i>Ajouter au paniert</span></button>
                    </div>
...
<script type="text/javascript">
          function CloseModal(){
            window.location.href="AfficherProduit.php?categories=<?php echo ($varb) ?>";
