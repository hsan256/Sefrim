...
if (isset($_GET['type'])) {
  $type = $_GET['type'];
  $result = $link->query("SELECT * FROM produit where tauxpromo != 0 order by $type LIMIT $start, $limit");
  $products = $result->fetch_all(MYSQLI_ASSOC);
}
else{
  $result = $link->query("SELECT * FROM produit where tauxpromo != 0 LIMIT $start, $limit");
  $products = $result->fetch_all(MYSQLI_ASSOC);
}
  $result1 = $link->query("SELECT COUNT(*) as `id` FROM produit where tauxpromo != 0");
 ...
 <ul class="level1" style="display: none;">
    ...
    <li class="level1 parent"><a href="http://htmldemo.themesmart.net/flavours/version2/"><span>Home Version 2</span></a></li>
                ...
                <!--sub sub category-->
                  ...
                  <li class="level1 nav-10-2"> <a href="list-offre_eddawakh.php"> <span>Product List</span> </a> </li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <ul>
            ...
            <li class="category1599"> <strong>Offre Iddawakh</strong> </li>
          </ul>
        </div>
        <!--col-xs-12-->
      </div>
    ...
    <div class="row">
      ...
      <div class="pro-coloumn">
        <article class="col-main">
          <div class="toolbar">
            <div class="sorter">
              <div class="view-mode"> <span title="Grid" class="button button-active button-grid">&nbsp;</span><a href="list-offre_eddawakh.php" title="List" class="button-list">&nbsp;</a> </div>
            </div>
            <div id="sort-by">
            ...
            <ul class="products-grid">
                 ...
                 <li class="item col-lg-4 col-md-3 col-sm-4 col-xs-6">
                   <div class="item-inner">
                     <div class="item-img">
                       <div class="item-img-info"><a href="product-detail-promo.html" title="Retis lapen casen" class="product-image"><img src="../../../BACK/views/'.$product['Image'].'" alt="Retis lapen casen"></a>
                         ...
                         <div class="item-info">
                           <div class="info-inner">
                             <div class="item-title"><a href="product-detail-promo.html" title="Retis lapen casen">'.$product['Nom'].' '.$product['tauxpromo'].'% OFF</a> </div>
                               <div class="item-content">
                                 ...
                                 <div class="item-price">
                                   <div class="price-box"><span class="regular-price" id="product-price-1"><span class="price">'.$product['Prix'].' Dinars/KG</span> </span> </div>
                                 </div>
                                 <div class="add_cart">
        ...
        <div class="side-nav-categories">
          ...
          <div class="box-content box-category">
            <ul>
              ...
              <!--level 0-->
              <li> <a href="Offre_eddawakh.php">Offre Iddawakh</a> </li>
              <!--level 0-->
  ...
  <ul>
    ...
    <li><a href="#">Pages</a>
      <ul>
        ...
        <li> <a href="list-offre_eddawakh.php">List</a></li>
...
<script type="text/javascript">
$('#clock').countdown('2020/6/20').on('update.countdown', function(event) {
