...
<!-- Afficher la liste des livreurs -->
   ...
   <?php
      ...
      $listeLivreur= $livreurC->TrierParNom();
        ...
        <div class="col-md-12" >
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item"><a href="#">Livreurs</a></li>
              <li class="breadcrumb-item active" aria-current="page">Liste Des Livreurs</li>
            </ol>
          </nav>
        </div>
          ...
          <div class="ms-panel" style="width: 1210px;">
            <div class="ms-panel-header">
              <h6>Liste Des Livreurs</h6>
               ...
               <td style="padding: 2px "><button type="button" style="padding: 5px ;margin-left:1000px;"class="btn btn-pill btn-outline-light"><a href="TrierParNom.php">Trier</a></button></td>

              <?php if($_GET['sup']==1) { ?>
                <div class="alert alert-danger" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Livreur supprimé.
                      </div>
                  <?php }else if($_GET['sup']==2){  ?>
              ...
              <?php
                    ...
                    ?>
                      <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Livreur bien ajouté.
                      </div>
                    <?php }else if($_GET['notification']==2){
                    ?>
                    <div class="alert alert-danger" role="alert">
                <strong>Echec!</strong> Vérifiez les champs .
            </div>
          <?php } ?>
                    ...
                    <tr>
                      ...
                      <td><img src="<?php echo $row['Image']; ?>" style="width: 110px;height: 30px"></td>
                       ...
                       <td><?php echo $row['Prenom']; ?></td>
                        ...
                        <td style="padding: 2px ">
                           <button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-primary" ><a href="ModifierLivreur.php?cin=<?PHP echo $row['Cin']; ?>">  Modifier </a></button>
                        </td>
                    </tr>
