...
include "../core/houaidaC.php";
    ...
    $result=$livraisonC->RecupererLivraison($_GET['idd']);

    //$result1=$livraisonC->RecupererLivreur();

    $nom="SELECT Nom from livreur where Etat=0";
          ...
          <div class="form-row">
                 ...
                 <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="date" name="DateLivraison" value="<?PHP echo $DateLivraison ?>" class="form-control" id="validationCustom24"  required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <input type="text" name="Statut" value="<?PHP echo $Statut ?>" class="form-control" id="validationCustom24" required>
                      <div class="invalid-feedback">
                        Please provide a city.
                      </div>
                    </div>
                  ...
                  <div class="col-xl-12 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">Selectionner le Livreur</label>
                    <div class="input-group">
                ...
                <div class="col-md-12">
                    ...
                    <input type="hidden" name="ref_ini" value="<?PHP echo $_GET['idd'];?>">  
                 </div>
...
if (isset($_POST['modifier'])){
  $livraison=new Livraison($id,$Adresse,$CodePostale,$_POST['DateLivraison'],$_POST['Statut'] ,$ModeLivraison,$Prix,$_POST['NomLivreur'],$Ville,$ModePaiment,$Gouvernaurat);
  $livraisonC->ModifierLivraison($livraison,$_POST['ref_ini']);
  echo ("<script language='javascript'>window.location.href='AfficherLivraison.php'</script>");
}
