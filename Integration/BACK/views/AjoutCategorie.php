...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    <!-- body wrapper -->
    <form action="ajouterCategorie.php" method="POST" enctype="multipart/form-data" name="f1">

     <div class="col-xl-6 col-md-12">
          <div class="ms-panel ms-panel-fh" style="width: 1000px ; margin-left: 120px; height: 450px;" >
            <div class="ms-panel-header">
              <h6>Ajouter Categories</h6>
            </div>
            <div class="ms-panel-body">
              <form class="needs-validation clearfix" novalidate>
                <div class="form-row">
                  <div class="col-xl-12 col-md-12">
                    <label for="validationCustom11">Nom Categories</label>
                    <div class="input-group">
                      <input type="text" name="Nom" class="form-control" id="verifnom" placeholder="Entrer le Nom..." required>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="input-group">
                      <textarea rows="5"  name="Description" id="verifdescription" class="form-control" placeholder="description..." required></textarea>
                      <div class="invalid-feedback">
                ...
                <button class="btn btn-primary float-right" type="submit" onclick="return verif();">Ajouter</button>
              </form>
            </div>
          </div>
        </div>
...
function num(ch){
  ...
  var id =document.getElementById('verifid').value;
