...
$db=config::getConnexion();
  ...
  //shipping stats...
  $req3= $db->query("SELECT Nom as nom ,Quantite as Quantite from produit GROUP BY  Nom");
  $req3->execute();
...
foreach ($liste3 as $row) {
   $dataPoints3[] = array('label' => $row->nom, 'y' => $row->Quantite);
}
?>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title: {
    text: "Gestion Du Stock De Produit"
  },
  data: [{
    type: "pie",
    startAngle: 240,
