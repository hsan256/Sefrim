        ...
        ?>
         ...
         <li class="ms-nav-item ms-search-form pb-0 py-0">
            ...
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <input type="text" class="ms-form-input" name="search" placeholder="Search here..." value="" id="rechercheclient" onkeypress="RecupVal(event)">
            ...
            <div class="ms-panel-header">
              ...
              <?php if($_GET['sup']==1) { ?>
                <div class="alert alert-danger" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Client supprimé.
                      </div>
                      ...
                      <td><img src="<?php echo $row['user_image']; ?>"></td>
                       ...
                       <td><?php echo $row['user_pass']; ?></td>
                        ...
                        <td style="padding: 2px ">
                         <form method="POST" action="SupprimerClient.php?Id=<?php echo($id);?>">
...
<!-- /Afficher la liste des livreurs -->
  ...
  <script type="text/javascript">
      ...
      function redirection(x){
        if(x==13){
          var res= document.getElementById('rechercheclient').value;
          if(res!=""){
          window.location.href = "RechercheClient.php?var1=" + res;
          }
        }
      }
  </script>
