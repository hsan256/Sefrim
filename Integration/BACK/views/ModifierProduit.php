...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    $result=$produitc1->RecupererProduit($Id);

    $result1=$produitc1->RecupererCategorie();
                ...
                <div class="form-row">
                  ...
                  <div class="col-xl-12 col-md-12 ">
                    ...
                    <div class="input-group">
                      <input type="text" name="Nom" value="<?PHP echo $Nom ?>" class="form-control" id="validationCustom10" placeholder="Saisir le nom du produit" required="">
                  ...
                  <div class="col-xl-12 col-md-12">
                    ...
                    <div class="input-group">
                        <select name="Type" class="form-control" id="validationCustom15" required="">
                  ...
                  <div class="col-xl-4 col-md-12">
                    ...
                    <div class="input-group">
                      <input type="text" name="Prix" value="<?PHP echo $Prix ?>" class="form-control" id="validationCustom17" placeholder="Entrer Le Prix unitaire" required="">
                      <div class="invalid-feedback">
                        Prix unitaire !
                      </div>
                    </div>
                  ...
                  <div class="col-xl-4 col-md-12">
                    ...
                    <div class="input-group">
                      <input type="text" name="Quantite" value="<?PHP echo $Quantite ?>" class="form-control" id="validationCustom18" placeholder="Saisir la Quantite" required="">
                      <div class="invalid-feedback">
                        Quantite !
                      </div>
                    </div>
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom18" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">DESCRIPTION</label>
                    <div class="input-group">
                      <input type="text" name="Description" value="<?PHP echo $Description ?>" class="form-control" id="validationCustom18" placeholder="Saisir la Quantite" required="">
                      <div class="invalid-feedback">
                        DESCRIPTION !
                      </div>
                    </div>
                  ...
                  <div class="col-md-12 ">
                    <label for="validationCustom12">Chargez l'image du produit de nouveau !</label>
                    <div class="custom-file">

                      <input  type="file" name="Image" value="<?PHP echo $Image ?>" class="custom-file-input" id="Image">
                  ...
                  <div class="col-md-12">
                    ...
                    <button class="btn btn-dark mr-2  ms-graph-metrics" value="Reset">Vider</button>
...
if (isset($_POST['modifier'])){
    ...
    $produit=new Produit($Id,$_POST['Nom'],$_POST['Type'],$_POST['Prix'],$_POST['Quantite'],$_POST['Description'],$target_file);
