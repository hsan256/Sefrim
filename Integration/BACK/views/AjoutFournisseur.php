...
<form action="AjoutFournisseur2.php" method="POST" enctype="multipart/form-data" name="f1">
  <div class="col-xl-6 col-md-12">
    <div class="ms-panel ms-panel-fh" style="width: 1000px ;margin-left : 120px;">
      <div class="ms-panel-header">
              <h5>Ajout Fournisseur</h5>
            </div>
        ...
        <form class="needs-validation clearfix" novalidate="">
          <div class="form-row">
               ...
               <div class="col-xl-12 col-md-12 ">
                ...
                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Link </label>
                    <div class="input-group">
                      <input type="text" name="Link" class="form-control" id="verifNom" placeholder="Saisir le nom du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <button class="btn btn-primary " type="submit" name="Ajouter" onclick=" return test()">Ajouter</button>
                 </div>
