    ...
    <div class="ms-content-wrapper">
      ...
      <div class="ms-profile-overview">
        <div class="ms-profile-cover">
          <img class="ms-profile-img" src="<?php echo($img); ?>" alt="people">
          <div class="ms-profile-user-info">
            <h1 class="ms-profile-username"><?php echo($nom); ?></h1>
      ...
      <div class="row">
        ...
        <div class="col-xl-5 col-md-12" style="margin: auto;">
          <div class="ms-panel ms-panel-fh">
            <div class="ms-panel-body">
              <ul class="ms-profile-stats">
                <li>
                  <h3 class="ms-count"></h3>
                  <span></span>
                </li>

              </ul>
              <h2 class="section-title">INFORMATION PERSONNELLE</h2>
              <table class="table ms-profile-information">
                <tbody>
                  <tr>
                    <th scope="row">NOM ET PRENOM</th>
                    <td><?php echo($prenom); ?> <?php echo($nom); ?></td>
                  </tr>
                  <tr>
