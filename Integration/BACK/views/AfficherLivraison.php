      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
       <li class="ms-nav-item ms-search-form pb-0 py-0">
            ...
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <input type="text" class="ms-form-input" name="search" placeholder="Search here..." value="" id="recherchelivraison" onkeypress="RecupVal(event)">
        ...
        <div class="col-md-12" >
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Liste Des Livraisons</li>
            </ol>
          </nav>
        ...
        <div class="col-xl-6 col-md-12"  >
          <div class="ms-panel" style="width: 1210px;">
            <div class="ms-panel-header">
              ...
              <td ><button type="button" style="padding: 5px ;margin-left:1000px;"class="btn btn-pill btn-outline-light"><a href="StatistiqueLivraison.php">Statistique</a></button></td>
              ...
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                      <th scope="col">Référence/ID commande</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row"></th>
                       ...
                       <td><?php echo $row['ModeLivraison']; ?></td>
                       <td><?php echo $row['Prix']; ?></td>
                       <td><?php echo $row['NomLivreur']; ?></td>
                       <td style="padding: 2px ">
                        
                          <input type="submit" name="supprimer" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-dark" onclick="window.location.href='SupprimerLivraison.php?id=<?php echo $row['id']; ?>&nom=<?php echo $row['NomLivreur']; ?>'" value="Supprimmer">
                       
                        </td>
                        <td style="padding: 2px ">
                           <button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-primary" ><a href="ModifierLivraison.php?idd=<?PHP echo $row['id']; ?>">  Modifier </a></button>
                        </td>
                         <td style="padding: 2px ">
                           <button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-primary" ><a href="impressionPDF.php?id=<?PHP echo $row['id']; ?>"> Imprimer</a></button>
                        </td>
                    </tr>
  ...
  <script src="assets/js/settings.js"></script>
   ...
   <script type="text/javascript">
      ...
      function redirection(x){
        if(x==13){
          var res= document.getElementById('recherchelivraison').value;
          if(res!=""){
          window.location.href = "Recherchelivraison.php?var1=" + res;
          }
        }
      }
  </script>
