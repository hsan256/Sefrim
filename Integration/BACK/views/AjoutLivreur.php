...
<form action="AjoutLivreur2.php" method="POST" enctype="multipart/form-data" name="f1">
          ...
          <div class="form-row">
               ...
               <div class="col-xl-12 col-md-12 ">
                  ...
                  <div class="input-group">
                    <input type="text" name="Cin" class="form-control" id="verifCin" placeholder="Saisir la cin" required="">
               ...
               <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Nom </label>
                    <div class="input-group">
                      <input type="text" name="Nom" class="form-control" id="verifNom" placeholder="Saisir le nom du livreur" required="">
                ...
                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Prénom </label>
                    <div class="input-group">
                      <input type="text" name="Prenom" class="form-control" id="verifPrenom" placeholder="Saisir le prénom du livreur" required="">
                      <div class="invalid-feedback">Nom !</div>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Age </label>
                    <div class="input-group">
                      <input type="text" name="Age" class="form-control" id="verifAge" placeholder="Saisir l'age du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                 </div>
                ...
                <div class="col-xl-12 col-md-12 ">
                  ...
                  <div class="input-group">
                    <input type="text" name="Email" class="form-control" id="verifMail" placeholder="Saisir l'aresse e-mail du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                   </div>
                </div>
                ...
                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Téléphone </label>
                   <div class="input-group">
                      <input type="text" name="Telephone" class="form-control" id="verifTel" placeholder="Saisir le numéro de téléphone du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-md-12">
                    ...
                    <div class="input-group">
                      <select name="Ville" class="form-control" id="verifVille" required="">
                ...
                <div class="col-md-12 ">
                    <label for="validationCustom12">Telechargez une Image</label>
                ...
                <div class="col-md-12">
                    ...
                    <button class="btn btn-primary " type="submit" onclick=" return test()">Ajouter</button>
                 </div>
