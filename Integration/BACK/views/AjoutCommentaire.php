...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    <!-- body wrapper -->
    <form action="AjouterCommentaire.php" method="POST" enctype="multipart/form-data" name="f1">
              ...
              <form class="needs-validation clearfix" novalidate>
                <div class="form-row">
                  <div class="col-xl-12 col-md-12">
                    <label for="validationCustom11">Identifiant Article</label>
                    <div class="input-group">
                      <input type="text" name="IdArticle" class="form-control" id="verifnom" value="<?php echo $_GET['Id'] ; ?>" required>
                ...
                <button class="btn btn-primary float-right" type="submit" onclick="return verif();">Commenter</button>
              </form>
            </div>
          </div>
        </div>
