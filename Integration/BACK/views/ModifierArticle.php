...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    $result=$Articlec1->RecupererArticle($Id);
              ...
              <form class="needs-validation clearfix" novalidate="">
                <div class="form-row">
                  ...
                  <div class="col-xl-12 col-md-12 ">
                    <label for="validationCustom10">Titre Article</label>
                    <div class="input-group">
                      <input type="text" name="Titre" value="<?PHP echo $Titre ?>" class="form-control" id="validationCustom10" required="">
                 ...
                 <div class="col-md-12 ">
                    <label for="validationCustom12">Chargez l'image de l'article de nouveau !</label>
                    <div class="custom-file">

                      <input  type="file" name="Image" value="" class="custom-file-input" id="Image">
                      <label class="custom-file-label" for="validatedCustomFile">Upload Article Image..</label>
...
if (isset($_POST['modifier'])){
    ...
    $Date_a="";
    $Article=new Article($Id,$_POST['Titre'],$Date_a,$_POST['Description'],$target_file);
    $Articlec1->ModifierArticle($Article,$_POST['id_ini']);
    $test=3;
