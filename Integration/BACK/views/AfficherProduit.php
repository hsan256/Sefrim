     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Promotion-page" class="collapse" aria-labelledby="Promotion-page" data-parent="#side-nav-accordion">
          <li> <a href="Sefrim_back_hsan/pages/Promotion/AjoutPromotion.php">Ajouter Une Promotions</a> </li>
          <li> <a href="Sefrim_back_hsan/pages/Promotion/ModifierPromotion.php">Modifier Une Promotions</a> </li>
          <li> <a href="Sefrim_back_hsan/pages/Promotion/SupprimerPromotion.php">Supprimmer Une Promotions</a> </li>
          <li> <a href="Sefrim_back_hsan/pages/Promotion/AfficherPromotion.php"> Afficher les Promotions</a> </li>
        ...
        ?>
         ...
         <li class="ms-nav-item ms-search-form pb-0 py-0">
            ...
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <input type="text" class="ms-form-input" name="search" placeholder="Search here..." value="" id="rechercheproduit" onkeypress="RecupVal(event)">
          ...
          <div class="ms-panel" style="width: 1210px;">
            <div class="ms-panel-header">
              <h6>Liste Des Produits</h6>
               <td ><button type="button" style="padding: 5px;margin-left: 1000px;margin-block-start:-30px;" class="btn btn-pill btn-outline-light"><a href="ImpressionPdfy.php">Imprimer</a></button></td>
                 <td ><button type="button" style="padding: 5px;margin-block-start:-70px; margin-left:850px;"class="btn btn-pill btn-outline-light"><a href="Statistique.php">Statistique</a></button></td>
              <?php
                      if($_GET['notification']==1){
                    ?>
                      <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Produit bien ajouté.
                      </div>
                    <?php }else if($_GET['notification']==2){
                    ?>
                    <div class="alert alert-danger" role="alert">
                       <strong>Succès!</strong> Produit bien supprimé.
              </div>
                 <?php }else if($_GET['notification']==3){?>
                 <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Produit bien mdifié.
                      </div>
            <?php }?>
            </div>
            <div class="ms-panel-body">
              ...
              <div class="table-responsive">
                <table id="data-table-7" class="table table-striped thead-primary w-100">
                  <thead>
                    <tr>
                      <th scope="col">#</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row"></th>
                       ...
                       <?php $nom=$row['Nom'];
                        $chemin='DetailProduit'.'.php';
                       ?>
                       <td><?php echo $row['Prix'];?></td>
                       <td><?php echo $row['Quantite']; ?></td>
                       <td style="padding: 2px"><button type="button" style="padding: 5px" class="btn btn-pill btn-primary"><a href="<?php echo($chemin); ?>?Id=<?php echo $row['Id'];?>">Détails</a></button></td>
...
<!-- /Afficher la liste des livreurs -->
  ...
  <script type="text/javascript">
      ...
      function redirection(x){
        if(x==13){
          var res= document.getElementById('rechercheproduit').value;
          if(res!=""){
          window.location.href = "RechercheProduit.php?var1=" + res;
          }
        }
      }
  </script>
