      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
       <li class="ms-nav-item ms-search-form pb-0 py-0">
            ...
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <input type="text" class="ms-form-input" name="search" placeholder="Search here..." value="" id="recherchelivreur" onkeypress="RecupVal(event)">
            ...
            <div class="ms-panel-header">
              ...
              <?php
                  ...
                  <?php }else if($_GET['notification']==3){
                    ?>
                    <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                      <strong>Succès!</strong> Livreur  modifié .
                    </div>
                    <?php }else if($_GET['notification']==4){
                    ?>
                    <div class="alert alert-danger" role="alert" style="margin-top: 25px;">
                      <strong>Echec!</strong> Verifiez votre modification .
                    </div>
              <?php } ?>
  ...
  <script src="assets/js/settings.js"></script>
   <script type="text/javascript">
      ...
      function redirection(x){
        if(x==13){
          var res= document.getElementById('recherchelivreur').value;
          if(res!=""){
          window.location.href = "recherchelivreur.php?var1=" + res;
          }
        }
      }
  </script>
