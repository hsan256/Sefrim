...
<!-- Afficher la liste des livreurs -->
   ...
   <?php 
      ...
      $listeArticle= $ArticleC->RechercheArticle($_GET['var1']);
              ...
              <?php
                    ...
                    ?>
                      <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Article bien ajouté.
                      </div>
                    <?php }else if($_GET['notification']==2){
                    ?>
                    <div class="alert alert-danger" role="alert">
                       <strong>Succès!</strong> Article bien supprimé.
              </div>
                 <?php }else if($_GET['notification']==3){?>
                 <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Article bien mdifié.
                      </div> 
            <?php }?>
            </div>
