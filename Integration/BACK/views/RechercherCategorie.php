...
<!-- Afficher la liste des livreurs -->
  ...
  <?php 
      ...
      $listeCategorie= $CategorieC->RechercheCategorie($_GET['var1']);
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row"></th>
                       ...
                       <td style="padding: 2px"><button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-dark" ><a href="SupprimerCategorie.php?Id=<?PHP echo $row['Id']; ?>">Supprimer</a></button></td>
