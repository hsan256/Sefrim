        ...
        ?>
         ...
         <li class="ms-nav-item ms-search-form pb-0 py-0">
            ...
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <input type="text" class="ms-form-input" name="search" placeholder="Search here..." value="" id="recherchearticle" onkeypress="RecupVal(event)">
            ...
            <div class="ms-panel-header">
              <h6>Liste Des Articles</h6>
               <td ><button type="button" style="padding: 5px;margin-left: 1000px;margin-block-start:-30px;" class="btn btn-pill btn-outline-light"><a href="ImpressionPdfArticle.php">Imprimer</a></button></td>
                 <td ><button type="button" style="padding: 5px;margin-block-start:-70px; margin-left:850px;"class="btn btn-pill btn-outline-light"><a href="StatistiqueArticle.php">Statistique</a></button></td>
              <?php
...
<!-- /Afficher la liste des livreurs -->
  ...
  <script type="text/javascript">
      ...
      function redirection(x){
        if(x==13){
          var res= document.getElementById('recherchearticle').value;
          if(res!=""){
          window.location.href = "RechercheArticle.php?var1=" + res;
          }
        }
      }
  </script>
