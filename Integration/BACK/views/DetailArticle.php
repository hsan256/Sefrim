...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    <!-- body wrapper -->
      ...
      $varb=$_GET['Id'];
      $listeArticle= $ArticleC->RecupererArticle($varb);
         ?>
        ...
        <div class="col-md-12">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Detail de l'Article</li>
            </ol>
          </nav>
        ...
        <div class="col-xl-6 col-md-12  bg-white">
          <div class="ms-panel shadow-none ms-panel-fh">
            <div class="ms-panel-body pb-0">
              ...
              <button class="btn btn-primary mr-3  ms-graph-metrics"><a href="ModifierArticle.php?Id=<?php echo $row['Id'];?>">Modifier</a></button>
              <button class="btn btn-dark ms-graph-metrics" name="supprimer"><a href="SupprimerArticle.php?Id=<?php echo $row['Id'];?>">Supprimer</a></button>
              <button class="btn btn-red ms-graph-metrics" name="supprimer" style="margin-left: 99px "><a href="AjoutCommentaire.php?Id=<?php echo $row['Id'];?>">Ajouter commentaire</a></button>
            </div>
 ...
 <?php 
      ...
      $listeCommentaire= $CommentaireC->RecupererCommentaire($_GET['Id']);
                ...
                <table class="table table-hover thead-primary ">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Identifiant Article</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['Description'];  ?></td>
                      <td style="padding: 2px"><button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-dark" ><a href="SupprimerCommentaire.php?Id=<?PHP echo $row['Id']; ?>">Supprimer</a></button></td>
                    </tr>
                  </tbody>
                   <?php }?>
                </table>
