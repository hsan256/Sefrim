...
include "../core/livreurC.php";
 ...
 //   $Etat=$row['Etat'];
      ...
      $vil="SELECT Ville from livreur";
      $listeVille=mysqli_query($conn,$vil);
      //$test=$_POST['Ville'];
        ...
        <form class="needs-validation clearfix" novalidate="">
          <div class="form-row">
               ...
               <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Carte d'identé</label>
                  <div class="input-group">
                    <input type="text" name="Cin" value="<?PHP echo $Cin ?>" class="form-control" id="validationCustom10" placeholder="Saisir la cin" required="">
                    <div class="invalid-feedback"> Identifiant !</div>
                  </div>
               </div>
               ...
               <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Nom </label>
                    <div class="input-group">
                      <input type="text" name="Nom" value="<?PHP echo $Nom ?>" class="form-control" id="validationCustom10" placeholder="Saisir le nom du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                </div>

                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Prénom </label>
                    <div class="input-group">
                      <input type="text" name="Prenom" value="<?PHP echo $Prenom ?>" class="form-control" id="validationCustom10" placeholder="Saisir le prénom du livreur" required="">
                      <div class="invalid-feedback">Nom !</div>
                    </div>
                </div>
                ...
                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Age </label>
                    <div class="input-group">
                      <input type="text" name="Age" value="<?PHP echo $Age ?>"  class="form-control" id="validationCustom10" placeholder="Saisir l'age du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                 </div>

                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Adresse E-mail </label>
                  <div class="input-group">
                    <input type="text" name="Email" value="<?PHP echo $Email ?>" class="form-control" id="validationCustom10" placeholder="Saisir l'aresse e-mail du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                   </div>
                </div>

                <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Téléphone </label>
                   <div class="input-group">
                      <input type="text" name="Telephone" value="<?PHP echo $Telephone ?>" class="form-control" id="validationCustom10" placeholder="Saisir le numéro de téléphone du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                </div>

            <!--    <div class="col-xl-12 col-md-12 ">
                  <label for="validationCustom10">Etat </label>
                   <div class="input-group">
                      <input type="text" name="Etat" value="<?PHP echo $Etat ?>" class="form-control" id="validationCustom10" placeholder="Saisir le numéro de téléphone du livreur" required="">
                      <div class="invalid-feedback"> Nom !</div>
                    </div>
                </div> -->

                <div class="col-xl-12 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">Selecionner la ville </label>
                    <div class="input-group">
                      <select name="Ville" class="form-control" id="validationCustom15" required="">
                      <?php while($row=mysqli_fetch_array($listeVille)){ ?>
                        <option value="<?php echo $row['Ville']; ?>"><?php echo $row['Ville'] ?></option>
                      <?php } ?>
                           
                      </select>
                    <!--  <select name="Ville" value="<?PHP echo $Ville ?>" class="form-control" id="validationCustom15" required="">
                        <option value="-1" selected="selected" disabled> Choisir une Ville </option>
                        <option value="Sidi Bou Said ">Sidi Bou Said</option>
                        <option value="La Marsa">La Marsa </option>
                        <option value="Les Berges du Lac">Les Berges du Lac</option>
                        <option value="L'Aouina">L'Aouina</option>
                      </select> 
...
if (isset($_POST['modifier'])){
  $livreur=new livreur($_POST['Cin'],$_POST['Nom'],$_POST['Prenom'],$_POST['Age'],$_POST['Email'] ,$_POST['Telephone'] ,$_POST['Ville']);
