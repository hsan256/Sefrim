...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    $result=$Categoriec1->RecupererCategorie($Id);
              ...
              <form class="needs-validation clearfix" novalidate="">
                <div class="form-row">
                  ...
                  <div class="col-xl-12 col-md-12 ">
                    <label for="validationCustom10">Nom categorie</label>
                    <div class="input-group">
                      <input type="text" name="Nom" value="<?PHP echo $Nom ?>" class="form-control" id="validationCustom10" placeholder="Saisir le nom du categorie" required="">
...
if (isset($_POST['modifier'])){
    $Categorie=new Categorie($Id,$_POST['Nom'],$_POST['Description']);
    $Categoriec1->ModifierCategorie($Categorie,$_POST['id_ini']);
    $test=3;
