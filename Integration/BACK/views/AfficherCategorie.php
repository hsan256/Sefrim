        ...
        ?>
         ...
         <li class="ms-nav-item ms-search-form pb-0 py-0">
            ...
            <div class="ms-form-group my-0 mb-0 has-icon fs-14">
              <input type="text" class="ms-form-input" name="search" placeholder="Search here..." value="" id="recherchecateg" onkeypress="RecupVal(event)">
        ...
        <div class="col-md-12" >
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Liste Des Categorie</li>
            </ol>
          </nav>
          <?php
                    ...
                    ?>
                      <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Catègorie bien ajouté.
                      </div>
                    <?php }else if($_GET['notification']==2){
                    ?>
                    <div class="alert alert-danger" role="alert">
                       <strong>Succès!</strong> Catègorie bien supprimé.
              </div>
                 <?php }else if($_GET['notification']==3){?>
                 <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Catègorie bien mdifié.
                      </div> 
            <?php }else if($_GET['notification']==5){?>
              <div class="alert alert-danger" role="alert">
                       <strong>Echec !</strong> Cette Catègorie Contient De(s) Produit(s).
                        </div> 
                        <?php } ?>
        </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th scope="row"></th>
                       ...
                       <td style="padding: 2px"><button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-dark" ><a href="SupprimerCategorie.php?Id=<?PHP echo $row['Id']; ?>&Nom=<?PHP echo $row['Nom']; ?>">Supprimer</a></button></td>
                       <td style="padding: 2px"><button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-primary" ><a href="ModifierCategorie.php?Id=<?PHP echo $row['Id']; ?>">Modifier</a></button></td>
...
<!-- /Afficher la liste des livreurs -->
  ...
  <script type="text/javascript">
      ...
      function redirection(x){
        if(x==13){
          var res= document.getElementById('recherchecateg').value;
          if(res!=""){
          window.location.href = "RechercherCategorie.php?var1=" + res;
          }
        }
      }
  </script>
