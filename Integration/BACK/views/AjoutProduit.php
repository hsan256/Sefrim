...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    $result=$ProduitC->RecupererCategorie();
   
    $vil="SELECT Nom from categorie";
    $listeCategorie=mysqli_query($conn,$vil);
    ?>
    <form action="ajouterProduit.php" method="POST" enctype="multipart/form-data" name="f1">
              ...
              <form class="needs-validation clearfix" novalidate="">
                <div class="form-row">
                  ...
                  <div class="col-xl-12 col-md-12 ">
                    <label for="validationCustom10">Nom Produit</label>
                    <div class="input-group">
                      <input type="text" name="Nom" class="form-control" id="verifnom" placeholder="Saisir le nom du produit" required="">
                  ...
                  <div class="col-xl-12 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">Selecionner catégories </label>
                    <div class="input-group">
                        <select name="Type" class="form-control" id="veriftype" required="">
                        <option value="-1" selected="selected" disabled> Choisir une catégorie </option>
                             <?php while($row=mysqli_fetch_array($listeCategorie)){ ?>
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom17" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">Prix unitaire</label>
                    <div class="input-group">
                      <input type="text" name="Prix" class="form-control" id="verifprix" placeholder="Entrer Le Prix unitaire" required="">
                      <div class="invalid-feedback">
                        Prix unitaire !
                      </div>
                    </div>
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom16">Devise</label>
                    <div class="input-group">
                      <select name="Devise" class="form-control" id="validationCustom16" required="">
                        <option value="-1">Selectionner l'unité</option>
                        <option value="Dinar">Dinar Tunisien</option>
                  ...
                  <div class="col-xl-4 col-md-12">
                    <label for="validationCustom18" data-toggle="tooltip" data-placement="left" title="3 digit number at the back of your card">Quantité</label>
                    <div class="input-group">
                      <input type="text" name="Quantite" class="form-control" id="verifquantite" placeholder="Saisir la Quantite" required="">
                      <div class="invalid-feedback">
                        Quantite !
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="input-group">
                      <textarea rows="5" name="Description" id="verifdescription" class="form-control" required=""></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <button type="reset" value="reset" class="btn btn-dark mr-2  ms-graph-metrics">Vider</button>
                    <button class="btn btn-primary " type="submit" name="upload" onclick="return verif();">Ajouter</button>
                  </div>
...
function num(ch){
  ...
  var type =document.getElementById('veriftype').selectedIndex;
  var prix =document.getElementById('verifprix').value;
  var quantite =document.getElementById('verifquantite').value;
  var description =document.getElementById('verifdescription').value;
  ...
  if(num(prix)==false || prix<1 || prix.indexOf('.') >= 0){
    alert('prix invalide');
    return false;
  }
  //if(num(quantite)==false || quantite<1 || quantite.indexOf('.') >= 0){
    //alert('quantite invalide');
    //return false;
  //}
  if(alpha(description)==false){
