...
<body class="ms-body ms-primary-theme ms-logged-out">
  ...
  <main class="body-content">
              ...
              ini_set('display_errors',0);
                    ...
                    ?>
                      <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                        <strong>Succès!</strong> Vous etes inscrit .
                      </div>
                    <?php }else if($_GET['notification']==2){
                    ?>
                    <div class="alert alert-danger" role="alert">
                       <strong>Erreur!</strong> Les Deux MDP sont Different !.
              </div>
                 <?php }else if($_GET['notification']==3){?>
                  <div class="alert alert-danger" role="alert">
                       <strong>Erreur!</strong> Adresse Mail EXISTE !.
              </div>
                 <?php }else if($_GET['notification']==4){ ?>
                  <div class="alert alert-danger" role="alert">
                       <strong>Erreur!</strong> Verifiez vos données !.
              </div>
                 <?php } else if($_GET['notification']==5){?>
                  <div class="alert alert-success" role="alert" style="margin-top: 25px;">
                       <strong>Succès!</strong> Nous Avons envoyés un email à votre adresse !.
              </div>
               <?php } ?>
        <div class="">
        ...
        <div class="ms-auth-col">
          <div class="ms-auth-form">
            ...
            <form class="needs-validation" novalidate="">
              ...
              <p>S'il vous plais entrez votre Email et votre mot de passe </p>
              <div class="mb-3">
                <label for="validationCustom08">Adresse mail</label>
                <div class="input-group">
                  <input type="email" class="form-control" id="Adresse" name="Adresse" placeholder="Email Address" required="">
              ...
              <button class="btn btn-primary mt-4 d-block w-100" name="login_a" type="submit">Se connecter</button>
              <span class="d-block text-center my-4">Or</span>
              <button type="button" class="btn mt-4 d-block w-100 btn-social-login"> <img src="assets/img/others/facebook.png" alt="image"> <span>Connexion avec Facebook</span> </button>
              <button type="button" class="btn mt-4 d-block w-100 btn-social-login"> <img src="assets/img/others/google.png" alt="image"> <span>Connexion avec Google</span> </button>
              <p class="mb-0 mt-3 text-center">Vous n'avez pas de compte ? <a class="btn-link" href="InscriptionAdmin.php">Créer un compte</a> </p>
            </form>
          </div>
        </div>
      </div>
    ...
    <form method="POST" action="Recuperermdp.php">
      ...
      <div class="modal-dialog modal-dialog-centered modal-min" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body text-center">
            ...
            <p> Entrer votre adresse email pour récuperer votre mot de passe </p>
            <form method="post">
              <div class="ms-form-group has-icon">
                <input type="text" placeholder="Email Address" class="form-control" name="Email2" value="">
                <i class="material-icons">email</i>
              </div>
              <button type="submit" class="btn btn-primary shadow-none">Récuperer Mot De Passe</button>
            </form>
          </div>
