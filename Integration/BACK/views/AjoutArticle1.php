...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  <main class="body-content">
    ...
    <form action="ajouterArticle.php" method="POST" enctype="multipart/form-data" name="f1">
                ...
                <div class="form-row">
                  ...
                  <div class="col-xl-12 col-md-12 ">
                    ...
                    <div class="input-group">
                      <input type="text" name="Titre" class="form-control" id="veriftitre" placeholder="Saisir le Titre de l'Article" required="">
                  ...
                  <div class="col-md-12 ">
                    <label for="validationCustom12">Upload Article Image</label>
...
function num(ch){
  ...
  function verif(){  
  var nom =document.getElementById('veriftitre').value;
