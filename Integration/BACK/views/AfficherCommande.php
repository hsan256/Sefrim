          ...
          <div class="ms-panel" style="width: 1210px;">
            ...
            <div class="ms-panel-body">
              ...
              <div class="table-responsive">
                ...
                $liste_commande=$commande1C->CompterCommande();
                   foreach ($liste_commande as $row)
                      {
                        $nb_commande=$row['count(*)'];

                 $liste_livreur=$commande1C->CompterLivreur();
                        foreach ($liste_livreur as $row)
                        {
                           $nb_livreur=$row['count(*)'];

                $etat=$commande1C->RecupererEtatLivreur();
                  foreach($etat as $row){
                      $EtatLivreur= $row['Etat'];


                if($EtatLivreur==0 && $nb_livreur!=0 )
                     {
                                ?>
                  <tbody>
                      ...
                      <th scope="row"></th>
                       ...
                       <td><?php echo $row['Prix']." Dt"; ?></td>
                        ...
                        <td style="padding: 2px ">
                           <button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-primary" ><a href="AjoutHouaida1.php?id=<?PHP echo $row['id']; ?>">  Passer à la livraison </a></button>
                        </td>
                    </tr>
                  </tbody>
                ...
                <?php }
                     ...
                     else if($EtatLivreur==1 && $nb_livreur==0 ){
                          ?>
                    ...
                    <tr>
                      <th scope="row"></th>
                       ...
                       <td><?php echo $row['Prix']." Dt"; ?></td>
                        ...
                        <td style="padding: 2px ">
                           <button type="button" style="padding: 5px ;margin: 8px" class="btn btn-pill btn-primary" >  Passer à la livraison </button>
                        </td>
                    </tr>
                  </tbody>
                   ...
                   <?php
                      if ( ($nb_commande==0)  ) { ?>
                        ...
                        <div class="alert alert-danger" role="alert">
                          <strong>Pas De Commande! </strong> Vous n'avez pas de commande a passé .
                       </div>

                   <?php }
                   else if(($EtatLivreur==1 && $nb_livreur==0)) { ?>
                    <div class="alert alert-danger" role="alert">
                          <strong>Vous ne Pouvez Passez votre Commande! </strong> Pas de livreur disponible .
                       </div>
                     <?php  } }
                         ?>
