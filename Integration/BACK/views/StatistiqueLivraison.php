...
$db=config::getConnexion();
  ...
  //shipping stats...
  $req3= $db->query("SELECT Gouvernaurat as gouvernaurat ,count(gouvernaurat) as nb_livraison from livraison GROUP BY  gouvernaurat");
  $req3->execute();
...
foreach ($liste3 as $row) {
   $dataPoints3[] = array('label' => $row->gouvernaurat, 'y' => $row->nb_livraison);
}
?>
...
var chart = new CanvasJS.Chart("chartContainer", {
  ...
  title: {
    text: "Les Adresses De livraison"
  },
  data: [{
    type: "pie",
    startAngle: 240,
    yValueFormatString: "##0 \"Gouvernaurat(s)\"",
    indexLabel: "{label} {y}",
