...
if (isset($_GET['view'])) {
  ...
  $sql  = "SELECT view_pub FROM product WHERE pid = $source ";
  $stmt = $ConnectingDB->prepare($sql);
  $stmt->execute();

  $DataRows = $stmt->fetch(PDO::FETCH_ASSOC);
  $view_pub = $DataRows['view_pub'];
  echo $view_pub;
  $view_pub += 1;
  echo $view_pub;
  $query  = "UPDATE product SET ";
  $query .= "view_pub = $view_pub ";
  $query .= "WHERE pid = $source ";
...
<!-- Mirrored from themesground.com/flavours/version1/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2020 11:56:18 GMT -->
<head>
<meta charset="utf-8">
              ...
              <form action="#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-sm-6 col-xs-12">
                  ...
                  <div class="product-image">
                    <div class="large-image"> <a href="products-images/p15.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img src="products-images/p15.jpg"> </a> </div>
                    <div class="flexslider flexslider-thumb">
                      <ul class="previews-list slides">
                        <li><a href='products-images/p15.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p15.jpg' "><img src="products-images/p15.jpg" alt = "Thumbnail 1"/></a></li>
                        <li><a href='products-images/p10.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p10.jpg' "><img src="products-images/p10.jpg" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p3.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p3.jpg' "><img src="products-images/p3.jpg" alt = "Thumbnail 1"/></a></li>
                        <li><a href='products-images/p4.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p4.jpg' "><img src="products-images/p4.jpg" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p5.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p5.jpg' "><img src="products-images/p5.jpg" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p8.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p8.jpg' "><img src="products-images/p8.jpg" alt = "Thumbnail 2"/></a></li>
                        <li><a href='products-images/p10.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'products-images/p10.jpg' "><img src="products-images/p10.jpg" alt = "Thumbnail 2"/></a></li>
                      </ul>
                    </div>
                  </div>
...
<!-- Mirrored from themesground.com/flavours/version1/product-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Apr 2020 11:56:21 GMT -->
</html>
