            ...
            <div class="ms-panel-body">
              <div class="table-responsive">
                <table class="table table-hover thead-primary">
                  ...
                  $stmt = $db_con->prepare("SELECT * FROM product where pub < 1 LIMIT {$startpoint} , {$per_page} ");
                  $stmt->execute();
                  ...
                  echo'
                    ...
                    echo'
                      ...
                      <td>'.$pr.' Dinar/KG  </td>
                      <td>'.$qt_dispo.'</td>
                      <td> <a href="add-pub.php?pid='.$pid.'" ><button type="submit" name="upload">Ajouter</a></button></td>
                    </tr>
                    <div class="col-md-12">
